...
<body style="padding-top: 70px;">
	...
	<div class="jumbotron text-center">
		...
		<form method="post" action="/login"  style="width: 30em; margin-left: 26em">
			<div class="form-group" >
				<label for="email">Email address:</label> <input type="email"
					class="form-control" placeholder="Enter email" id="email" name="email" required="required">
			</div>
			<div class="form-group">
				<label for="role">Account type:</label> <select class="form-control" name="role" id="role" required="required"> 
