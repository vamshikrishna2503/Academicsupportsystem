...
<body style="padding-top: 70px; background-color:  #041243; color: white;" >
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="/admin/reports">Reports</a></li>
			</ul>
	...
	<div class="container">
		...
		<div class="text-center">
			<h3 class="display-3">Reports</h3>
			<hr />
		</div>
		<div class="table">
			<table class="table table-striped table-bordered table-hover"
				style="font-size: 0.9e; color: grey" id="users">
				<thead>
					<tr>
						<th>File name</th>
						<th>File type</th>
		...
		<form method="post" action="/admin/reports/monthly" name="reportForm" id="reportForm">
			<div class="form-group">
				<label>Select month</label><select name="month" class="form-control"
					id="month" required>
		...
		<form method="post" action="/admin/reports/yearly" name="reportForm" id="reportForm">
