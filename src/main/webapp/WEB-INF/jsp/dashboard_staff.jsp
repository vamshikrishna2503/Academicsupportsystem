	...
	<div class="container">
		...
		<div class="container-fluid" style="margin-left: 27em">
			...
			<a type="button" class="btn btn-default btn-lg btn-block"
				style="padding-top: 1.6em; height: 5em; width: 20em"
				href="/staff/queries">Queries</a><a type="button"
				class="btn btn-default btn-lg btn-block"
				style="padding-top: 1.6em; margin-top: 2em; height: 5em; width: 20em"
				href="/staff/appointments">Appointments</a> <a type="button"
				class="btn btn-default btn-lg btn-block"
				style="padding-top: 1.6em; margin-top: 2em; height: 5em; width: 20em"
				href="/staff/reports">Reports</a>
